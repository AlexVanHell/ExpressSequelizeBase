...
exports.handleSuccess = function (req, res, body, status, code) {
	...
	const responseCode = RESPONSE_CODES.SUCCESS[code] || { code: 1000, message: 'Se realízo la operación exitosamente' };

	return res.status(httpResponse.code).json({
		code: responseCode.code,
		http_code: httpResponse.code,
...
exports.handleError = function (req, res, err, status, code) {
	...
	const responseCode = RESPONSE_CODES.ERROR[code] || { code: 1000, message: 'Hubo un error al procesar la solicitud' };
